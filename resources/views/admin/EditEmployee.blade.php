                                                    ...
                                                    <form class="mx-1 mx-md-4" action="{{ route('update_Emp', $employee->id) }}"
                                                        ...
                                                        <div class="d-flex flex-row align-items-center mb-4">
                                                            ...
                                                            <div class="form-outline flex-fill mb-0">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="designation" id="form3Example4c"
                                                                    class="form-control" />
                                                                @error('designation')
                                                                    <span class="validate">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        {{-- <div class="d-flex flex-row align-items-center mb-4">
                                                            ...
                                                            <div class="form-outline flex-fill mb-0">
                                                                ...
                                                                <input type="password" value="{{$employee->password}}" name="password"
                                                        ...
                                                        <div class="d-flex flex-row align-items-center mb-4">
                                                            ...
                                                            <div class="form-outline flex-fill mb-0">
                                                                <label class="form-label" for="form3Example3c">Confirm
                                                                    Password</label>
                                                                <input type="password" value="{{$employee->confirmpassword}}" name="confirmpassword"
                                                                    id="form3Example3c" class="form-control" />
